###########################################################
###Qwen3ForCausalLM and Qwen3ForSequenceClassification have the same architecture.

#1.load the model and extract lm_head weight matrix
#2.extract the rows of "yes" and "no" tokens (i.e yes_id = tokenizer.convert_tokens_to_ids("yes"))
...
print("\n--- SAVING MODEL ---")
output_dir = "./qwen3-reranker-seq-cls"
